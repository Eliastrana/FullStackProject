...
public class UserController {
     ...
     */
    @Operation(summary = "Register a new user", description = "Registers a user and returns a JWT token for authentication", responses = {
        @ApiResponse(responseCode = "200", description = "Successfully registered user", content = @Content(schema = @Schema(implementation = AuthenticationResponse.class))),
     ...
     * @see AuthenticationResponse
     */
    @Operation(summary = "Log in a user", description = "Logs in a user and returns a JWT token for authentication", responses = {
    ...
    @Operation(summary = "Get user details", description = "Fetches the details of the currently authenticated user", responses = {
        @ApiResponse(responseCode = "200", description = "User details fetched successfully", content = @Content(schema = @Schema(implementation = UserDetailsDTO.class))),
    ...
    @Operation(summary = "Get all users", description = "Fetches all users in the system with their details", responses = {
        @ApiResponse(responseCode = "200", description = "Users fetched successfully", content = @Content(schema = @Schema(implementation = UserDetailsDTO.class))),
    ...
    @Operation(summary = "Delete user", description = "Deletes a user from the system", responses = {
