...
public class TagDTO {
    ...
    /**
     * The unique identifier of the tag. This UUID serves as a primary key for tag-related operations,
     * ensuring the tag's distinct identity across the system.
     */
    @Schema(description = "The unique identifier of the tag.", example = "d7b8df5e-4567-4f1e-8c2f-3de0b6b6f1a4")
    private UUID id;

    /**
     * The name of the tag, which typically represents a topic or category related to the questions it's associated with.
     */
    ...
    /**
     * A set of unique identifiers for questions associated with this tag. This allows questions to be grouped by shared topics or themes.
     */
